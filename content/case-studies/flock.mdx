...
hero:
  ...
  logoUrl: /images/projects/flock-logo.svg
  customLogoComponent: FlockLogo
...
metrics:
  ...
  - value: "89%"
    label: Satisfaction
    description: With suggested times
...
ai:
  route: /projects/flock
  highlightId: project-flock
  summary: Flock is an AI-powered scheduling tool that finds optimal meeting times by analyzing calendar patterns, time zones, and individual energy levels. Features natural language input, smart suggestions with reasoning, and automatic time zone fairness distribution.
  keywords:
    - scheduling
    - AI
    - productivity
    ...
    - calendar
  achievements:
    - 2,500+ active teams in beta
    - 73% reduction in scheduling time
    - 89% satisfaction with suggested meeting times
    - 45% decrease in cancelled meetings
---
