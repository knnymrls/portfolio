    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="experiments-container bg-[#ffffff] box-border content-stretch flex flex-col gap-5 items-start justify-start p-[16px] relative rounded-[20px] shrink-0 w-full border border-[#e9e9e9]"
            >
                <div className="box-border content-stretch flex flex-col gap-4 items-start justify-center p-0 relative shrink-0 w-full">
                    ...
                    <motion.div
                        ...
                        className="experiments-item bg-[#ffffff] box-border content-stretch flex flex-col lg:flex-row gap-4 h-[299px] items-start justify-start overflow-clip p-0 relative rounded-[20px] shrink-0 w-full border border-[#e9e9e9]"
                    >
